...
const string strMessageMagic = "RuBits Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // RuBits: 1 days
static const int64 nTargetSpacing = 120; // RuBits: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal rubits miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RuBits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xeab7a1bd37876687fcc9a5114ca414f28bb0b9540d2bdc8f1997d21119b6d00e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Geneisis of Rubits 1 Dec 2013 1408";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385906859; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1385906859;
            block.nNonce   = 178429;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x30bcce3a9f63a819d1d2154e0103a6d54ba4c1d049ebed1d4ff0d2eb9fe64a0c"));
